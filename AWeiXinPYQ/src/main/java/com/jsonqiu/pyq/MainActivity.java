...
import com.jsonqiu.pyq.adapter.DynamicsAdapter;
...
public class MainActivity extends Activity {
    ...
    private String TAG = "^_^MainActivity^_^";

    @Override
    protected void onCreate(Bundle savedInstantate) {
        super.onCreate(savedInstantate);
