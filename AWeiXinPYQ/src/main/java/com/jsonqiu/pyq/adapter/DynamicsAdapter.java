package com.jsonqiu.pyq.adapter;
...
import com.jsonqiu.pyq.constants.Constants;
import com.jsonqiu.pyq.model.DynamicsModel;
import com.jsonqiu.pyq.util.DateUtil;
import com.jsonqiu.pyq.util.ImageLoadUtils;
import com.jsonqiu.study.R;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static com.jsonqiu.pyq.util.DateUtil.FULL_TIME;

/**
 * Created by JsonQiu on 2017/7/9
 */
    ...
    protected void convert(BaseViewHolder helper, final DynamicsModel item) {
        ...
        switch (helper.getItemViewType()) {
            case Constants.SHARE_VIDEO:
                //分享视频的布局，对应了 上面     ⬆️构造函数填入的布局，下面以此类推，要做的就是填入数据
            ...
            case Constants.SHARE_GAIN:
                ...
                helper.setOnClickListener(R.id.ivGain, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(mContext," = 点击SHARE_GAIN = " +adapterPosition,Toast.LENGTH_SHORT).show();
                    }
                });
                break;
            ...
            case Constants.LIKE_VIDEO:
                ...
                helper.getView(R.id.rlLikeVideo).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(mContext," = 点击LIKE_VIDEO = " +adapterPosition,Toast.LENGTH_SHORT).show();
...
//                giftSb.show((TextView) helper.getView(R.id.tvGiftAction));
                ...
                helper.getView(R.id.ivOperation).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(mContext," = 点击GIFT = " +adapterPosition,Toast.LENGTH_SHORT).show();
            ...
            case COMMENT_NONE_IMG:
                ...
                helper.getView(R.id.ivVideo).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(mContext," = 000COMMENT_NONE_IMG000 = " +adapterPosition,Toast.LENGTH_SHORT).show();
                    }
                });
                break;
            ...
            case COMMENT_WITH_IMG:
                ...
                helper.getView(R.id.ivVideo).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(mContext," = 111COMMENT_NONE_IMG111 = " +adapterPosition,Toast.LENGTH_SHORT).show();
            ...
            case Constants.BAISHI:
                ...
                helper.getView(R.id.ivMasterHead).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(mContext," = BAISHI = " +adapterPosition,Toast.LENGTH_SHORT).show();
